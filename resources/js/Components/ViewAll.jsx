...
import { handleDownload } from '../Utilities/UtilityFunctions'
export default function ViewAll({ list, setLoader, location , exceList }) {
            ...
            <div className="view-content">
                ...
                <div className='view-filter'>
                    <div className='view-filter-options'>
                        ...
                        <div className='filter-data'>
                            <button onClick={(e) => handleDownload(exceList ? exceList: null ,'Order List')} className='clear-search' style={{ background: 'green' }}>Download</button>
                        </div>
                    </div>
                </div>
                {
